...
{
    public partial class UrunGirisCikisRaporu : Form
    {
        public UrunGirisCikisRaporu()
        {
            InitializeComponent();
        ...
        private void btnFiyatiDegisecek_Click(object sender, EventArgs e)
        {
            FiyatiDegisecekUrunler fiyatiDegisecekUrunler = new FiyatiDegisecekUrunler();
            fiyatiDegisecekUrunler.Show();
            this.Hide();
        }
